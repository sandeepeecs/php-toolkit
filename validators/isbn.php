...
define('PTK_ISBN_10_MODULO_DIVISOR', 11);
define('PTK_ISBN_13_MODULO_DIVISOR', 10);
...
function is_valid_isbn($isbn)
{
  ...
  if(10 == $isbn_length)
  {
    ...
    return (10 == ($isbn_mod = ($isbn_sum % PTK_ISBN_10_MODULO_DIVISOR))) ? ('x' == mb_strtolower(array_shift($isbn_digits), 'UTF-8')) : ($isbn_mod == array_shift($isbn_digits));
  }
  ...
  if(13 == $isbn_length)
  {
    ...
    return (0 == ($isbn_mod = ($isbn_sum % PTK_ISBN_13_MODULO_DIVISOR))) ? (0 == array_shift($isbn_digits)) : ($isbn_mod == (10 - array_shift($isbn_digits)));
  }
